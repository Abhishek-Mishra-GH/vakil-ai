...
function resolveHeader(pathname: string) {
  const match = Object.entries(HEADER_MAP).find(([prefix]) => pathname.startsWith(prefix));
  ...
  return (
    <header className="top-nav-wrap">
      <div className="top-nav">
        ...
        <div id="topnav-portal-target" style={{ flex: 1, margin: "0 24px", display: "flex", alignItems: "center" }} />
