  ...
  if (glyph === "folder") {
    return (
      <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <path
          d="M4 7.5h5l1.5 2H20v7.5A1.5 1.5 0 0 1 18.5 18.5h-13A1.5 1.5 0 0 1 4 17V7.5Z"
          fill="currentColor"
        />
      </svg>
    );
...
export default function AppSidebar() {
  ...
  return (
    <aside
      className={`app-sidebar white-theme ${collapsed ? "collapsed" : ""}`}
    >
      <div
